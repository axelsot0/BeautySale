...
// Botón "Ver demo en vivo": al hover abre un portal flotante (overlay,
// no empuja layout) con miniatura en vivo del demo.
  ...
  return (
    ...
    >
      ...
      >
        <a
          href={DEMO_URL}
          className="portal-glow relative block rounded-[26px] p-[3px]"
